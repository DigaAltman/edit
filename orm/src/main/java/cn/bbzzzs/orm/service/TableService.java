...
import cn.bbzzzs.orm.common.DaoEnum;
import cn.bbzzzs.orm.factotry.ConnectionFactory;
import cn.bbzzzs.orm.handler.dao.DaoHandler;
import cn.bbzzzs.orm.pojo.*;
import cn.bbzzzs.orm.repositoy.TableDao;
...
public class TableService {
    ...
    static {
        cn.bbzzzs.orm.handler.dao.support.mapper.mybatis.Mapper mybatisMapper = new cn.bbzzzs.orm.handler.dao.support.mapper.mybatis.Mapper();
        cn.bbzzzs.orm.handler.dao.support.applicationproperties.mybatis.Application mybatisApplication = new cn.bbzzzs.orm.handler.dao.support.applicationproperties.mybatis.Application();
        cn.bbzzzs.orm.handler.dao.support.pom.mybatis.Pom mybatisPom = new cn.bbzzzs.orm.handler.dao.support.pom.mybatis.Pom();
        ...
        cn.bbzzzs.orm.handler.dao.support.mapper.springdatajpa.Mapper jpaRepository = new cn.bbzzzs.orm.handler.dao.support.mapper.springdatajpa.Mapper();
        cn.bbzzzs.orm.handler.dao.support.applicationproperties.springdatajpa.Application jpaApplication = new cn.bbzzzs.orm.handler.dao.support.applicationproperties.springdatajpa.Application();
        cn.bbzzzs.orm.handler.dao.support.pom.springdatajpa.Pom jpaPom = new cn.bbzzzs.orm.handler.dao.support.pom.springdatajpa.Pom();
        ...
        cn.bbzzzs.orm.handler.dao.support.mapper.mybatisplus.Mapper mybatisPlusMapper = new cn.bbzzzs.orm.handler.dao.support.mapper.mybatisplus.Mapper();
        cn.bbzzzs.orm.handler.dao.support.applicationproperties.mybatisplus.Application mybatisPlusApplication = new cn.bbzzzs.orm.handler.dao.support.applicationproperties.mybatisplus.Application();
        cn.bbzzzs.orm.handler.dao.support.pom.mybatisplus.Pom mybatisPlusPom = new cn.bbzzzs.orm.handler.dao.support.pom.mybatisplus.Pom();
        ...
        cn.bbzzzs.orm.handler.dao.support.mapper.springjdbc.Mapper jdbcMapper = new cn.bbzzzs.orm.handler.dao.support.mapper.springjdbc.Mapper();
        cn.bbzzzs.orm.handler.dao.support.applicationproperties.springjdbc.Application jdbcApplication = new cn.bbzzzs.orm.handler.dao.support.applicationproperties.springjdbc.Application();
        cn.bbzzzs.orm.handler.dao.support.pom.springjdbc.Pom jdbcPom = new cn.bbzzzs.orm.handler.dao.support.pom.springjdbc.Pom();
    ...
    /**
     * 基于表结构生成 Mapper 层, 包括 POJO 层, VO 层
     * TODO 暂时还没有实现
     */
